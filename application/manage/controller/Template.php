...
class Template extends User{
    ...
    function _initialize()
    {
        parent::_initialize();
      	...
      	$viewPath = config('template.view_path');//模板路径
        $this->viewSuffix = config('template.view_suffix');//模板后缀名
		$viewPath = $viewPath ? $viewPath : 'themes/moban1';
        $this->filepath = ROOT_PATH.'/'.$viewPath.'/';
        $this->publicpath =  ROOT_PATH.'public/themes/Home/';
    ...
    public function delete(){
    	$html=config('template.view_suffix');

...
--
-- Table structure for table `tp_articles`
--
...
--
-- Table structure for table `tp_clt_article`
--

DROP TABLE IF EXISTS `tp_clt_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_clt_article` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
--
-- Table structure for table `tp_field`
--
...
--
-- Table structure for table `tp_manage`
--
...
--
-- Table structure for table `tp_manage_cate`
--

DROP TABLE IF EXISTS `tp_manage_cate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_manage_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `permissions` text COMMENT '权限菜单',
  `create_time` int(11) NOT NULL,
...
--
-- Table structure for table `tp_manage_log`
--

DROP TABLE IF EXISTS `tp_manage_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_manage_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `manage_menu_id` int(11) NOT NULL COMMENT '操作菜单id',
  `manage_id` int(11) NOT NULL COMMENT '操作者id',
  `ip` varchar(100) DEFAULT NULL COMMENT '操作ip',
...
--
-- Table structure for table `tp_manage_menu`
--

DROP TABLE IF EXISTS `tp_manage_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_manage_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `module` varchar(50) NOT NULL COMMENT '模块',
  `controller` varchar(100) NOT NULL COMMENT '控制器',
...
--
-- Table structure for table `tp_page`
--
...
--
-- Table structure for table `tp_wx_auth`
--

DROP TABLE IF EXISTS `tp_wx_auth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_auth` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tp_wx_default_replay`
--

DROP TABLE IF EXISTS `tp_wx_default_replay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_default_replay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tp_wx_fans`
--

DROP TABLE IF EXISTS `tp_wx_fans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_fans` (
...
--
-- Table structure for table `tp_wx_follow_replay`
--

DROP TABLE IF EXISTS `tp_wx_follow_replay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_follow_replay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `instance_id` int(11) NOT NULL COMMENT '店铺id',
  `reply_media_id` int(11) NOT NULL COMMENT '回复媒体内容id',
  `sort` int(11) NOT NULL,
...
--
-- Table structure for table `tp_wx_key_replay`
--

DROP TABLE IF EXISTS `tp_wx_key_replay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_key_replay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `instance_id` int(11) NOT NULL COMMENT '店铺id',
...
--
-- Table structure for table `tp_wx_media`
--
...
--
-- Table structure for table `tp_wx_media_item`
--

DROP TABLE IF EXISTS `tp_wx_media_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_media_item` (
...
--
-- Table structure for table `tp_wx_user_msg`
--

DROP TABLE IF EXISTS `tp_wx_user_msg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_user_msg` (
...
--
-- Table structure for table `tp_wx_user_msg_replay`
--

DROP TABLE IF EXISTS `tp_wx_user_msg_replay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tp_wx_user_msg_replay` (
...
-- Dump completed on 2018-04-10 15:59:13
